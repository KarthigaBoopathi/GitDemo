...
namespace sep14lib
{
    ...
    public class Searching
    {
        ...
        {
            movies.Add(new Movie("Kgf2", "Tamil", "Action", 20));
            movies.Add(new Movie("KRK", "Tamil", "Love", 40));
            movies.Add(new Movie("Premam", "Malayalam", "Love", 50));
            movies.Add(new Movie("Arunthathi", "Tamil", "Thriller", 60));
            movies.Add(new Movie("Vikram", "Tamil", "Action", 34));
        }
        public void search()
        {
    ...
    public class CustomerUser : Searching
    {
        ...
        {
            if (Id == 9566503541 && Password == "123456789")
            {
                login = "true";
                return true;
            }
